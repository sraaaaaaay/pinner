...
the original source file. Always notify the user that you're consulting their curated
examples, rather than searching the code. Do not proceed to use search unless the
indexed files clearly aren't relevant.
$(cat ./pins/INDEX.md)
</pinner-index>
EOF
